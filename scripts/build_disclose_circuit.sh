...
echo "building zkey"
snarkjs groth16 setup build/disclose.r1cs build/powersOfTau28_hez_final_20.ptau build/disclose.zkey
...
echo "building vkey"
echo $RAND_STR | snarkjs zkey contribute build/disclose.zkey build/disclose_final.zkey
snarkjs zkey export verificationkey build/disclose_final.zkey build/disclose_vkey.json

snarkjs zkey export solidityVerifier build/disclose_final.zkey build/Verifier_disclose.sol
